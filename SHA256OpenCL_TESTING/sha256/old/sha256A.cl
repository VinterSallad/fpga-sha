...
uint8_t crypto_hashblocks_sha256_g(__local uint8_t *statebytes,
    ...
    //Medan det finns chunks som inte är sista chunksen, processera
    while (inlen >= 64) {
        uint32_t w0  = load_bigendian_32_g(in + 0);
        uint32_t w1  = load_bigendian_32_g(in + 4);
        uint32_t w2  = load_bigendian_32_g(in + 8);
        uint32_t w3  = load_bigendian_32_g(in + 12);
        uint32_t w4  = load_bigendian_32_g(in + 16);
        uint32_t w5  = load_bigendian_32_g(in + 20);
        uint32_t w6  = load_bigendian_32_g(in + 24);
        uint32_t w7  = load_bigendian_32_g(in + 28);
        uint32_t w8  = load_bigendian_32_g(in + 32);
        uint32_t w9  = load_bigendian_32_g(in + 36);
        uint32_t w10 = load_bigendian_32_g(in + 40);
        uint32_t w11 = load_bigendian_32_g(in + 44);
        uint32_t w12 = load_bigendian_32_g(in + 48);
        uint32_t w13 = load_bigendian_32_g(in + 52);
        uint32_t w14 = load_bigendian_32_g(in + 56);
        uint32_t w15 = load_bigendian_32_g(in + 60);
